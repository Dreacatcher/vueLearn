...
;(function(W, $, B, M, U) {
	...
	Remote.prototype.hasTicketPackageParamBase = function _packageParamBase(param) {
		var package_ = {
			head: {
				siteid: Info.siteid,
				appid: Info.appid,
				accessTicket:'491f6f4a06364947855decf693163a71',//_getAccessTicket(), //'491f6f4a06364947855decf693163a71',
				sign: B.encrypt(Info.appkey, B.toMd5(B.toBase64(Info.appid + B.toJson(param)))),
				version: "2.0"
			},
			body: param
